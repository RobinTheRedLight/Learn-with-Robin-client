    ...
    return (
        <div>
            ...
            <div tabIndex={1} className="mt-3 collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                ...
                <div className="collapse-content">
                    <p>Firebase allows users to authenticate with their phone number, email, Google, and Facebook accounts. For the authentication service I am using firebase for my project.
                        Other options are : STYTCH, Auth0, AWS Cognito, Okta, and Stormpath.
                    </p>
                </div>
            </div>
            ...
            <div tabIndex={3} className="mt-3 collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                ...
                <div className="collapse-content">
                    <p>Node.js is an open-source server environment. Node.js is cross-platform and runs on Windows, Linux, Unix, and macOS. Node.js is a back-end JavaScript runtime environment. Node.js runs on the V8 JavaScript Engine and executes JavaScript code outside a web browser.
                    </p>
                </div>
            </div>
        </div>
